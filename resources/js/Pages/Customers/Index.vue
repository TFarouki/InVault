...
const deleteCustomer = () => {
    deletingId.value = customerToDelete.value.id;
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    <tr v-for="customer in customers.data" :key="customer.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">{{ customer.ice || '-' }}</td>
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            <button @click="openEditModal(customer)" class="p-2 text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 rounded-lg transition-colors" :title="$t('edit')">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </button>
                            <button @click="confirmDelete(customer)" class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition-colors" :title="$t('delete')">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md shadow-2xl">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Delete Customer</h3>
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <button @click="deleteCustomer" :disabled="form.processing" class="px-6 py-2 rounded-xl bg-red-600 text-white font-bold hover:bg-red-700 transition-colors disabled:opacity-50">
