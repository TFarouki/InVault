            ...
            >
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    :href="route('cash-denominations.index')"
                                    :active="route().current('cash-denominations.*')"
                                >
                                    {{ $t('Cash') }}
                                </NavLink>
                                <NavLink
                                    :href="route('shifts.status')"
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('inventory.index')" :active="route().current('inventory.*')">Inventory</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('reports.index')" :active="route().current('reports.*')">Reports</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('settings.index')" :active="route().current('settings.*')">Settings</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('cash-denominations.index')" :active="route().current('cash-denominations.*')">Cash</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('shifts.status')" :active="route().current('shifts.*')">Shift</ResponsiveNavLink>
